    ...
    <div className="max-w-5xl mx-auto px-6 py-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 bg-slate-100/50 p-8 rounded-2xl">
        ...
        <div className="flex flex-col justify-center space-y-6">
          <div>
            <span className="text-xs uppercase font-bold text-blue-600 tracking-wider">{data?.prod?.tag}</span>
            <h1 className="text-3xl font-bold text-slate-900 mt-1">{data?.prod?.title}</h1>
            <p className="text-2xl font-bold text-slate-900 mt-2">{data?.prod?.price}</p>
          </div>
